...
int main()
{
  ...
  int num_thrs_per_block_i = 32;
  int num_thrs_per_block_j = 32;

  int num_blocks_i = (ni + num_thrs_per_block_i - 1) / num_thrs_per_block_i;
  int num_blocks_j = (nj + num_thrs_per_block_j - 1) / num_thrs_per_block_j;

  dim3 threadsPerBlock(num_thrs_per_block_i, num_thrs_per_block_i, 1);
  dim3 numBlocks(num_blocks_i, num_blocks_j, 1);
